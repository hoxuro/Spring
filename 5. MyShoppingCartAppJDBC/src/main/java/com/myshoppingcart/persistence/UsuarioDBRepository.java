...
public class UsuarioDBRepository implements IUsuarioRepository {
    ...
    public Usuario updateUsuario(Usuario actUsuario) throws Exception {
        ...
        try (
            ...
            stmt.setString(1, actUsuario.getNombre());
            stmt.setString(2, actUsuario.getApellido());
            stmt.setString(3, actUsuario.getEmail());
            stmt.setInt(4, actUsuario.getInteres());
            stmt.setDouble(5, actUsuario.getSaldo());
            stmt.setString(6, actUsuario.getPassword());
            stmt.setString(7, actUsuario.getNacimiento().toString());
            stmt.setInt(8, actUsuario.isActivo() ? 1 : 0);
            stmt.setInt(9, actUsuario.getUid());
